...
public class FormActualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<h2>Formulacio de actualización</h2>");

            cdr = sentenciaSQL.executeQuery(consulta);
            out.println("<form action='/40-BasesDatosActualizacion/Actualizar' method='post'>");
            out.println("<select name='depto'>");
            while (cdr.next()) {
            ...
            out.println("<br /><br />");
            out.println("Nombre<input type='text' name='dnombre' />");
            out.println("<br />");
            out.println("Localidad<input type='text' name='localidad' />");
            out.println("<br />");
