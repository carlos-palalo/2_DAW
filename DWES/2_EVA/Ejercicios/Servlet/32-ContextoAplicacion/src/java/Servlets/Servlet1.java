...
public class Servlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<title>32-ContextoAplicacion - Contexto de la aplicación</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>32-ContextoAplicacion - Contexto de la aplicación</h1><h2>Página 1</h2><hr />");
            ...
            out.println("<hr /><a href='" + request.getContextPath() + "/Servlet2'>Página 2</a>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
