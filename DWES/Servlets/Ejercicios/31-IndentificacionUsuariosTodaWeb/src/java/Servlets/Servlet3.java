...
public class Servlet3 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>27-IndentificacionObjetoUsuarioTodaWeb - Usar un objeto usuario como variable de sesión</h1><h2>Página 3</h2><hr />");
            ...
            if(valido){
                ...
                out.println("<h3>Contenido de la página 3</h3>");
