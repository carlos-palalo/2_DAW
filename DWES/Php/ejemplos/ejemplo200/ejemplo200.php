...
$resultado=mysqli_query($conexion,"SELECT demo42.DNI,demo42.Nombre,demo42.Apellido1,demo42.Apellido2,demodat422.Puntos FROM demo42,demodat422 WHERE (demo42.DNI=demodat422.DNI) ");
